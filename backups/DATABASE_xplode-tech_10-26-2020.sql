...
CREATE TABLE `academy` (
 ...
 INSERT INTO academy (`id`,`name`,`contact`,`address`,`details`,`principle`,`logo`,`created_at`,`updated_at`) VALUES ('1','The Learning Academy','02 -2030120','Floor 321, Main Street, West road','This is a Academy with well furnished equipment & highly qualified faculty providing quality education with the mission to let you shine your future','corona.jpeg','kids-1508121_1280.jpg','2020-06-12 16:55:17','2020-10-08 12:28:51');
...
CREATE TABLE `expenses` (
 ...
 INSERT INTO expenses (`id`,`title`,`amount`,`date`,`description`,`status`,`created_at`,`updated_at`) VALUES ('11','Gas bill','7000','2020-10-21','DOne','primary','2020-06-10 04:10:26','2020-06-09 18:10:26');

 INSERT INTO expenses (`id`,`title`,`amount`,`date`,`description`,`status`,`created_at`,`updated_at`) VALUES ('12','Net bill','1500','2020-10-07','DOne','temporary','2020-06-10 04:10:51','2020-06-09 18:10:51');
...
CREATE TABLE `master` (
 ...
 INSERT INTO master (`id`,`fee_type_id`,`fee_group_id`,`student_id`,`amount`,`status`,`payment`,`due_date`,`paid`,`fine`,`discount`,`balance`,`created_at`,`updated_at`) VALUES ('180','11','13','35','1500','paid','','0000-00-00','1500','0','600','0','2020-07-03 03:00:21','2020-07-02 17:00:21');
 ...
 INSERT INTO master (`id`,`fee_type_id`,`fee_group_id`,`student_id`,`amount`,`status`,`payment`,`due_date`,`paid`,`fine`,`discount`,`balance`,`created_at`,`updated_at`) VALUES ('182','12','19','48','1000','Unpaid','','0000-00-00','0','0','0','1000','2020-07-27 07:44:09','2020-07-26 21:44:09');

 INSERT INTO master (`id`,`fee_type_id`,`fee_group_id`,`student_id`,`amount`,`status`,`payment`,`due_date`,`paid`,`fine`,`discount`,`balance`,`created_at`,`updated_at`) VALUES ('183','12','19','45','1000','Unpaid','','0000-00-00','0','0','0','1000','2020-09-28 20:29:09','2020-09-28 10:29:09');
